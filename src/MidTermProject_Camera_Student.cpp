...
int main(int argc, const char *argv[])
{
    ...
    write_a("results.csv", "Detector Type");
    write_a("results.csv", ",");
    write_a("results.csv", "Descriptor Type");
    write_a("results.csv", ",");
    write_a("results.csv", "Detector Time");
    write_a("results.csv", ",");
    write_a("results.csv", "Preceding Vehicle Keypoints");
    write_a("results.csv", ",");
    write_a("results.csv", "Descriptor Time");
    write_a("results.csv", ",");
    ...
    for (int i = 0; i < detectors.size(); i++)
    {
        ...
        for (int j = 0; j < descriptors.size(); j++)
        {
            ...
            for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex++)
            {
                ...
                // write_a("results.csv", "Detector Type: ");
                // write_a("results.csv", ",");
                write_a("results.csv", detectorType);
                write_a("results.csv", ",");
                // write_a("results.csv", "Descriptor Type: ");
                // write_a("results.csv", ",");
                write_a("results.csv", descriptorType);
                write_a("results.csv", ",");
                ...
                if (bFocusOnVehicle)
                {
                    ...
                    // write_a("results.csv", "# of keypoints on the preceding vehicle: ");
                    // write_a("results.csv", ",");
                    write_a("results.csv", to_string(keypoints.size()));
                    write_a("results.csv", ",");
                }
